...
namespace UKHO.ADDS.Clients.FileShareService.Tests.Models
{
    public class BatchSearchResponseTests
    {
        ...
        public void TestEquals()
        {
            ...
            var batchSearchResponse1a = new BatchSearchResponse { Count = 2, Entries = new List<BatchDetails> { new("batch1"), new("batch2") }, Links = new Links(new Link("selfLink1")), Total = 2 };
            var batchSearchResponse1b = new BatchSearchResponse { Count = 2, Entries = batchSearchResponse1.Entries, Links = batchSearchResponse1.Links, Total = 2 };

            var batchSearchResponse2 = new BatchSearchResponse { Count = 1, Entries = new List<BatchDetails> { new("batch1") }, Links = new Links(new Link("selfLink1"), new Link("first"), new Link("previous")), Total = 2 };
        ...
        public void TestToJson()
        {
            ...
            var batchSearchResponse = new BatchSearchResponse { Count = 2, Entries = batchDetailsList, Links = links, Total = 9 };
