...
using System;
using UKHO.ADDS.Clients.Kiota.FileShareService.Batch.Item;
...
namespace UKHO.ADDS.Clients.Kiota.FileShareService.Batch
{
    ...
    {
        /// <summary>Gets an item from the UKHO.ADDS.Clients.Kiota.FileShareService.batch.item collection</summary>
        /// <param name="position">A Batch ID.</param>
        /// <returns>A <see cref="global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.Item.WithBatchItemRequestBuilder"/></returns>
        public global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.Item.WithBatchItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("batchId", position);
                return new global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.Item.WithBatchItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BatchRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/batch{?%24filter*,limit*,start*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BatchRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/batch{?%24filter*,limit*,start*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchGetResponse?> GetAsBatchGetResponseAsync(Action<RequestConfiguration<global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchRequestBuilder.BatchRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchGetResponse> GetAsBatchGetResponseAsync(Action<RequestConfiguration<global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchRequestBuilder.BatchRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchGetResponse>(requestInfo, global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchGetResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Returns a list of batches in FSS with their files. Only committed batches that have not expired will be returned.
        /// </summary>
        /// <returns>A <see cref="global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchResponse"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::UKHO.ADDS.Clients.Kiota.FileShareService.Models.ErrorDescription">When receiving a 400 status code</exception>
        [Obsolete("This method is obsolete. Use GetAsBatchGetResponseAsync instead.")]
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchResponse?> GetAsync(Action<RequestConfiguration<global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchRequestBuilder.BatchRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchResponse> GetAsync(Action<RequestConfiguration<global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchRequestBuilder.BatchRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchResponse>(requestInfo, global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Create a new batch to upload files into.
        /// </summary>
        /// <returns>A <see cref="global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchPostResponse"/></returns>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchPostResponse?> PostAsBatchPostResponseAsync(global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchPostResponse> PostAsBatchPostResponseAsync(global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchPostResponse>(requestInfo, global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchPostResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Create a new batch to upload files into.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchResponse?> PostAsync(global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchResponse> PostAsync(global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchRequestBuilder.BatchRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchRequestBuilder.BatchRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchRequestBuilder WithUrl(string rawUrl)
        {
            return new global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Returns a list of batches in FSS with their files. Only committed batches that have not expired will be returned.
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class BatchRequestBuilderGetQueryParameters 
        {
...
#nullable restore
            ...
            public string Filter { get; set; }
#endif
            /// <summary>Specify the limit of the number of results returned in one page. Also known as page size. Optional parameter and defaults to 10 results per page. If specified, must be greater or equal to 1.</summary>
            [QueryParameter("limit")]
            public int? Limit { get; set; }
            /// <summary>Specify the index of the first item returned in the results. Defaults to 0 (the first item). Used with pagination. If specified, must be greater than or equal to 0. If greater than the number of results, the service will return status code 400 (Bad Request).</summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class BatchRequestBuilderGetRequestConfiguration : RequestConfiguration<global::UKHO.ADDS.Clients.Kiota.FileShareService.Batch.BatchRequestBuilder.BatchRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
