...
namespace UKHO.ADDS.Clients.FileShareService.ReadOnly.Tests.Models
{
    public class BatchDetailsFilesTests
    {
        ...
        public void TestEquals()
        {
            ...
            {
                Attributes = new List<BatchDetailsAttributes> { new("key1", "value1"), new("key2", "value2") },
            ...
            {
                Attributes = new List<BatchDetailsAttributes> { new("key1", "value2"), new("key2", "value2") },
                Links = new BatchDetailsLinks(new Link("getFileLink")),
                Filename = "File123.png",
                FileSize = 123456,
                Hash = "XEsVGA3neuA4B3aR9AWUZw=="
        ...
        public void TestToJson()
        {
            ...
            var expectedJson = $"{{\"filename\":\"{batchDetailsFiles.Filename}\",\"fileSize\":{batchDetailsFiles.FileSize},\"hash\":\"{batchDetailsFiles.Hash}\",\"attributes\":[{string.Join(",", batchDetailsFiles.Attributes.Select(a => a.ToJson()))}],\"links\":{batchDetailsFiles.Links.ToJson()}}}";
