...
using ApiSdk.Batch.Item.Files.Item;
using ApiSdk.Models;
...
using System;
namespace ApiSdk.Batch.Item.Files
{
    /// <summary>
    ...
    {
        /// <summary>Gets an item from the ApiSdk.batch.item.files.item collection</summary>
        ...
        public global::ApiSdk.Batch.Item.Files.Item.WithFilenameItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("filename", position);
                return new global::ApiSdk.Batch.Item.Files.Item.WithFilenameItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Batch.Item.Files.FilesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Batch.Item.Files.FilesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::ApiSdk.Batch.Item.Files.FilesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::ApiSdk.Batch.Item.Files.FilesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
