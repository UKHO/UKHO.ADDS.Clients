...
namespace ApiSdk.Batch
{
    ...
    {
        /// <summary>Gets an item from the ApiSdk.batch.item collection</summary>
        /// <param name="position">A Batch ID.</param>
        /// <returns>A <see cref="global::ApiSdk.Batch.Item.WithBatchItemRequestBuilder"/></returns>
        public global::ApiSdk.Batch.Item.WithBatchItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("batchId", position);
                return new global::ApiSdk.Batch.Item.WithBatchItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::ApiSdk.Batch.BatchRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Batch.BatchGetResponse"/></returns>
...
#nullable enable
        public async Task<global::ApiSdk.Batch.BatchGetResponse?> GetAsBatchGetResponseAsync(Action<RequestConfiguration<global::ApiSdk.Batch.BatchRequestBuilder.BatchRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ApiSdk.Batch.BatchGetResponse> GetAsBatchGetResponseAsync(Action<RequestConfiguration<global::ApiSdk.Batch.BatchRequestBuilder.BatchRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::ApiSdk.Batch.BatchGetResponse>(requestInfo, global::ApiSdk.Batch.BatchGetResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Returns a list of batches in FSS with their files. Only committed batches that have not expired will be returned.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::ApiSdk.Batch.BatchResponse?> GetAsync(Action<RequestConfiguration<global::ApiSdk.Batch.BatchRequestBuilder.BatchRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::ApiSdk.Batch.BatchResponse> GetAsync(Action<RequestConfiguration<global::ApiSdk.Batch.BatchRequestBuilder.BatchRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::ApiSdk.Batch.BatchResponse>(requestInfo, global::ApiSdk.Batch.BatchResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Returns a list of batches in FSS with their files. Only committed batches that have not expired will be returned.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Batch.BatchRequestBuilder.BatchRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::ApiSdk.Batch.BatchRequestBuilder.BatchRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::ApiSdk.Batch.BatchRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::ApiSdk.Batch.BatchRequestBuilder WithUrl(string rawUrl)
        {
            return new global::ApiSdk.Batch.BatchRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Returns a list of batches in FSS with their files. Only committed batches that have not expired will be returned.
        /// </summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class BatchRequestBuilderGetRequestConfiguration : RequestConfiguration<global::ApiSdk.Batch.BatchRequestBuilder.BatchRequestBuilderGetQueryParameters>
        {
        }
    }
}
