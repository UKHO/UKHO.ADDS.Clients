...
namespace UKHO.ADDS.Clients.FileShareService.ReadOnly
{
    public interface IFileShareReadOnlyClient
    {
        ...
        Task<IResult<Stream>> DownloadFileAsync(string batchId, string fileName, Stream destinationStream, long fileSizeInBytes = 0, CancellationToken cancellationToken = default);
