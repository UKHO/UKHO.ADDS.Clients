...
#nullable enable
        public global::UKHO.ADDS.Clients.Kiota.SalesCatalogueService.Models.ProductVersions_cancellation? Cancellation { get; set; }
#nullable restore
#else
        public global::UKHO.ADDS.Clients.Kiota.SalesCatalogueService.Models.ProductVersions_cancellation Cancellation { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::UKHO.ADDS.Clients.Kiota.SalesCatalogueService.Models.ProductVersions_dates>? Dates { get; set; }
#nullable restore
#else
        public List<global::UKHO.ADDS.Clients.Kiota.SalesCatalogueService.Models.ProductVersions_dates> Dates { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "cancellation", n => { Cancellation = n.GetObjectValue<global::UKHO.ADDS.Clients.Kiota.SalesCatalogueService.Models.ProductVersions_cancellation>(global::UKHO.ADDS.Clients.Kiota.SalesCatalogueService.Models.ProductVersions_cancellation.CreateFromDiscriminatorValue); } },
                { "dates", n => { Dates = n.GetCollectionOfObjectValues<global::UKHO.ADDS.Clients.Kiota.SalesCatalogueService.Models.ProductVersions_dates>(global::UKHO.ADDS.Clients.Kiota.SalesCatalogueService.Models.ProductVersions_dates.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::UKHO.ADDS.Clients.Kiota.SalesCatalogueService.Models.ProductVersions_cancellation>("cancellation", Cancellation);
            writer.WriteCollectionOfObjectValues<global::UKHO.ADDS.Clients.Kiota.SalesCatalogueService.Models.ProductVersions_dates>("dates", Dates);
