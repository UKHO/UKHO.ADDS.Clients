...
namespace UKHO.ADDS.Clients.Kiota.FileShareService.Attributes.Search
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::UKHO.ADDS.Clients.Kiota.FileShareService.Attributes.Search.SearchRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::UKHO.ADDS.Clients.Kiota.FileShareService.Attributes.Search.SearchGetResponse?> GetAsSearchGetResponseAsync(Action<RequestConfiguration<global::UKHO.ADDS.Clients.Kiota.FileShareService.Attributes.Search.SearchRequestBuilder.SearchRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::UKHO.ADDS.Clients.Kiota.FileShareService.Attributes.Search.SearchGetResponse> GetAsSearchGetResponseAsync(Action<RequestConfiguration<global::UKHO.ADDS.Clients.Kiota.FileShareService.Attributes.Search.SearchRequestBuilder.SearchRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::UKHO.ADDS.Clients.Kiota.FileShareService.Attributes.Search.SearchGetResponse>(requestInfo, global::UKHO.ADDS.Clients.Kiota.FileShareService.Attributes.Search.SearchGetResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Get a list of the batch attributes and their values that have been applied to batches for a batch search.
        /// </summary>
        /// <returns>A <see cref="global::UKHO.ADDS.Clients.Kiota.FileShareService.Attributes.Search.SearchResponse"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::UKHO.ADDS.Clients.Kiota.FileShareService.Models.ErrorDescription">When receiving a 400 status code</exception>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::UKHO.ADDS.Clients.Kiota.FileShareService.Attributes.Search.SearchResponse?> GetAsync(Action<RequestConfiguration<global::UKHO.ADDS.Clients.Kiota.FileShareService.Attributes.Search.SearchRequestBuilder.SearchRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::UKHO.ADDS.Clients.Kiota.FileShareService.Attributes.Search.SearchResponse> GetAsync(Action<RequestConfiguration<global::UKHO.ADDS.Clients.Kiota.FileShareService.Attributes.Search.SearchRequestBuilder.SearchRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::UKHO.ADDS.Clients.Kiota.FileShareService.Attributes.Search.SearchResponse>(requestInfo, global::UKHO.ADDS.Clients.Kiota.FileShareService.Attributes.Search.SearchResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Get a list of the batch attributes and their values that have been applied to batches for a batch search.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::UKHO.ADDS.Clients.Kiota.FileShareService.Attributes.Search.SearchRequestBuilder.SearchRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::UKHO.ADDS.Clients.Kiota.FileShareService.Attributes.Search.SearchRequestBuilder.SearchRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::UKHO.ADDS.Clients.Kiota.FileShareService.Attributes.Search.SearchRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::UKHO.ADDS.Clients.Kiota.FileShareService.Attributes.Search.SearchRequestBuilder WithUrl(string rawUrl)
        {
            return new global::UKHO.ADDS.Clients.Kiota.FileShareService.Attributes.Search.SearchRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Get a list of the batch attributes and their values that have been applied to batches for a batch search.
        /// </summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class SearchRequestBuilderGetRequestConfiguration : RequestConfiguration<global::UKHO.ADDS.Clients.Kiota.FileShareService.Attributes.Search.SearchRequestBuilder.SearchRequestBuilderGetQueryParameters>
        {
        }
    }
}
