...
namespace UKHO.ADDS.Clients.FileShareService.Readonly.Tests.Models
{
    public class BatchDetailsTests
    {
        ...
        public void TestEquals()
        {
            ...
            var batchDetails1 = new BatchDetails { BatchId = Guid.NewGuid().ToString(), BusinessUnit = "BU1", Status = BatchDetails.StatusEnum.Incomplete };
        ...
        {
            var batchDetails = new BatchDetails { BatchId = Guid.NewGuid().ToString(), BusinessUnit = "BU1", Status = BatchDetails.StatusEnum.Incomplete };
