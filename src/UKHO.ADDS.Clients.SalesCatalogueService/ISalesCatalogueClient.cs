...
namespace UKHO.ADDS.Clients.SalesCatalogueService
{
    public interface ISalesCatalogueClient
    {
        ...
        public Task<IResult<S100ProductNamesResponse>> GetS100ProductNamesAsync(List<string> productNames, string correlationId, CancellationToken cancellationToken = default);
    }
}
